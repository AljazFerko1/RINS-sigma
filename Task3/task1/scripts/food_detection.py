...
class food_recognizer:
    ...
    def find_food(self):
        ...
        for cnt in cnts:
            ...
            #print(k)
            if 0.3 < aspect_ratio < 3 and 900 < area < 1200:
        ...
        cv2.drawContours(img, filtered_cnts, -1, (255, 0, 0), 3)
        
        #cv2.imshow("Contour window",img)
        #cv2.waitKey(1)

        # Fit elipses to all extracted contours
        elps = [cv2.fitEllipse(cnt) for cnt in filtered_cnts if cnt.shape[0] >= 10]
