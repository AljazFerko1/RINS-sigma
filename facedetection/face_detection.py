...
class face_localizer:
    ...
    def extract_face(self, img, required_size=(224, 224), plot=False):
    ...
    def face_recognition(self, rgb_image, pose):
        face = {"new": self.extract_face(rgb_image)}
            ...
            if confidence > 0.6:
                ...
                if pose is not None and face_distance < 1.75:
                    ...
                    if c == False:
                        ...
                        self.face_recognition(rgb_image, pose)
